package pixikdev.ru.dtxvisual.client.ui.mainmenu;

import pixikdev.ru.dtxvisual.client.render.builders.impl.BlurBuilder;
import pixikdev.ru.dtxvisual.client.render.builders.impl.RectangleBuilder;
import pixikdev.ru.dtxvisual.client.render.builders.impl.TextBuilder;
...
public class MainMenu extends Screen {
    ...
    public MainMenu() {
        super(Text.literal(I18n.translate("dtxvisual.mainmenu.screen_title")));
    ...
    protected void init() {
        ...
        // Add buttons
        buttons.add(new AnimatedButton(centerX, centerY - buttonHeight * 2f - margin * 2, buttonWidth, buttonHeight, I18n.translate("dtxvisual.mainmenu.singleplayer"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new SelectWorldScreen(this), this))));

        buttons.add(new AnimatedButton(centerX, centerY - buttonHeight - margin, buttonWidth, buttonHeight, I18n.translate("dtxvisual.mainmenu.multiplayer"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new MultiplayerScreen(this), this))));

        buttons.add(new AnimatedButton(centerX, centerY, buttonWidth, buttonHeight, I18n.translate("dtxvisual.mainmenu.options"),
        ...
        buttons.add(new AnimatedButton(centerX, centerY + buttonHeight + margin, halfWidth, buttonHeight, I18n.translate("dtxvisual.mainmenu.altmanager"),
                btn -> startExitAnimation(new AnimatedScreenWrapper(new AltManagerScreen(this), this))));
        buttons.add(new AnimatedButton(centerX + halfWidth + margin, centerY + buttonHeight + margin, halfWidth, buttonHeight, I18n.translate("dtxvisual.mainmenu.quit"),
        ...
        if (!welcomePlayed) {
            ...
            MinecraftClient.getInstance().getSoundManager().play(
                    PositionedSoundInstance.master(
                            SoundEvent.of(Identifier.of("dtxvisual:welcome")),
                            1.0f,
                            1.0f
                    )
            );
