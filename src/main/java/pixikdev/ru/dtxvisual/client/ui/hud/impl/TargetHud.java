...
import pixikdev.ru.dtxvisual.client.util.Network.Server;
import pixikdev.ru.dtxvisual.client.util.animations.Easing;
import pixikdev.ru.dtxvisual.client.util.animations.infinity.InfinityAnimation;
...
import pixikdev.ru.dtxvisual.modules.impl.utility.NameProtect;
...
public class TargetHud extends HudElement implements ThemeManager.ThemeChangeListener {
    ...
    private static final Identifier STAR_TEX = DtxVisual.id("hud/star.png");
