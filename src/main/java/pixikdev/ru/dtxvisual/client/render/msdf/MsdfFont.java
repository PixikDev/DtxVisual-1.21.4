package pixikdev.ru.dtxvisual.client.render.msdf;
...
import pixikdev.ru.dtxvisual.client.render.msdf.FontData.AtlasData;
import pixikdev.ru.dtxvisual.client.render.msdf.FontData.GlyphData;
import pixikdev.ru.dtxvisual.client.render.msdf.FontData.MetricsData;
import pixikdev.ru.dtxvisual.client.render.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = DtxVisual.id("fonts/" + dataFileName + ".json");
			return this;
		}

		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = DtxVisual.id("fonts/" + atlasFileName + ".png");
			return this;
		}
