package pixikdev.ru.dtxvisual.client.render.renderers.impl;
...
import pixikdev.ru.dtxvisual.client.render.renderers.IRenderer;
...
public record RockstarBuiltRectangle(
        SizeState size,
    ...
    private static final ShaderProgramKey RECTANGLE_SHADER_KEY = new ShaderProgramKey(ResourceProvider.getShaderIdentifier("rock_rectangle"), VertexFormats.POSITION_COLOR, Defines.EMPTY);
