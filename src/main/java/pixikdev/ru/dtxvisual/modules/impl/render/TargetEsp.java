...
import pixikdev.ru.dtxvisual.client.render.renderers.JelloRenderer;
import pixikdev.ru.dtxvisual.client.render.renderers.SoulRenderer;
...
public class TargetEsp extends Module implements ThemeManager.ThemeChangeListener {
    ...
    private void renderMarkerMain(EventRender2D e, Vec3d centerWorld, float animVal, int colorRGBA) {
        ...
        Render2D.drawTexture(
                ...
                0f,
                DtxVisual.id(modeMarkerNew.getValue() ? "hud/alt_marker.png" : "hud/marker.png"),
                finalColor
        );
